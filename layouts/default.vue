      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <nav class="hidden md:flex items-center gap-6">
            <NuxtLink to="/discover" class="text-zinc-400 hover:text-violet-400 transition-colors">
              Discover
            </NuxtLink>
            <NuxtLink to="/artists" class="text-zinc-400 hover:text-violet-400 transition-colors">
              Artists
            </NuxtLink>
            <NuxtLink to="/pricing" class="text-zinc-400 hover:text-violet-400 transition-colors">
              Pricing
            </NuxtLink>
          </nav>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-zinc-400">
              <li><NuxtLink to="/about" class="hover:text-violet-400 transition-colors">About</NuxtLink></li>
          ...
          <div>
            ...
            <ul class="space-y-2 text-zinc-400">
              <li><NuxtLink to="/terms" class="hover:text-violet-400 transition-colors">Terms</NuxtLink></li>
              <li><NuxtLink to="/privacy" class="hover:text-violet-400 transition-colors">Privacy</NuxtLink></li>
              <li><NuxtLink to="/contact" class="hover:text-violet-400 transition-colors">Contact</NuxtLink></li>
            </ul>
          </div>
        </div>
