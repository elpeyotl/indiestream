    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="mb-12">
        ...
        <p class="text-zinc-400 text-lg">
          Track all the updates and improvements to Indiestream.
        </p>
...
useHead({
  title: 'Changelog - Indiestream',
  meta: [
    { name: 'description', content: 'See what\'s new in Indiestream - all updates, improvements, and bug fixes.' },
  ],
})
