    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-zinc-950 border-2 border-zinc-800 p-8 shadow-[4px_4px_0px_0px_rgba(139,92,246,0.5)]">
        <div class="text-center mb-8 border-b-2 border-zinc-800 pb-6">
          <h1 class="text-2xl font-black uppercase tracking-tighter text-white">WELCOME BACK</h1>
          <p class="text-zinc-400 font-mono text-sm mt-1">Sign in to your account</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-bold uppercase tracking-tight text-zinc-300 mb-2">Password</label>
            <input
              v-model="password"
              type="password"
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                v-model="rememberMe"
                type="checkbox"
                class="w-4 h-4 border-2 border-zinc-800 bg-black text-fuchsia-500 focus:ring-fuchsia-500 rounded-none"
              />
              <span class="text-zinc-400 font-mono text-sm">Remember me</span>
            </label>
            <NuxtLink to="/forgot-password" class="text-sm font-mono text-fuchsia-500 hover:text-fuchsia-400">
              Forgot password?
            </NuxtLink>
          </div>
        ...
        <div class="mt-6 pt-6 border-t-2 border-zinc-800 text-center">
          <p class="text-zinc-400 font-mono text-sm">
            ...
            <NuxtLink to="/register" class="text-fuchsia-500 hover:text-fuchsia-400 font-bold">
              Sign up
            </NuxtLink>
          </p>
        </div>
