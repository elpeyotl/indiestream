<template>
  <div class="container mx-auto px-4 py-12">
    <div class="max-w-3xl mx-auto">
      <h1 class="text-3xl font-bold text-zinc-100 mb-2">Terms of Service</h1>
      ...
      <div class="prose prose-invert prose-zinc max-w-none">
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc list-inside text-zinc-400 space-y-2 ml-4">
            ...
            <li>Artist profiles and music hosting</li>
            <li>Revenue distribution to artists based on listener engagement</li>
          </ul>
        </section>

        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">3. User Accounts</h2>
          <p class="text-zinc-400 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">4. Subscriptions and Payments</h2>
          <p class="text-zinc-400 mb-4">
            Paid subscriptions are billed on a monthly basis. By subscribing, you authorize us to charge your payment method on a recurring basis. You may cancel your subscription at any time, and you will continue to have access until the end of your billing period.
          </p>
        </section>
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">6. Prohibited Content</h2>
          <p class="text-zinc-400 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">8. Termination</h2>
          <p class="text-zinc-400 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">9. Disclaimers</h2>
          <p class="text-zinc-400 mb-4">
            The Service is provided "as is" without warranties of any kind. We do not guarantee uninterrupted access to the Service or that the Service will be error-free.
          </p>
        </section>
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">11. Changes to Terms</h2>
          <p class="text-zinc-400 mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold text-zinc-100 mb-4">12. Contact</h2>
